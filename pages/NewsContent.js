...
export default class PostView extends Component {
  ...
  likeUnlikePost = async () => {
    Alert.alert(
      "Sistema",
      "¿Está seguro que desea dar me gusta o quitar me gusta a esta noticia?",
      [
        {
          text: "Cancelar",
          onPress: () => {},
  ...
  handleReport = async () => {
    ...
    formData.append("haciaGUID", this.state.idNew);
    formData.append("tipoReporte", "Noticia");
    formData.append("fecha", moment(currentDate).format("YYYY-MM-DD"));
          ...
          renderItem={(item) => {
            ...
            return (
              <View style={styles2.container}>
                <TouchableOpacity
                  onPress={() =>
                    this.navigateToOtherProfile(Notification.usuarioGUID)
                  }
                >
                  <Image
                    style={styles2.image}
