...
export default class SignUp extends Component {
  constructor(props) {
    ...
    this.state = {
      ...
      passwordConfirm: "",
      image:
        "https://media.istockphoto.com/id/1073597286/vector/driver-license-with-male-photo-identification-or-id-card-template-vector-illustration.jpg?s=170667a&w=is&k=20&c=ZGfrRxbVbSOjW5dV0XKrfYOYHIuOJwo4Du3R5NDxcFY=",
      uploading: false,
      sourceImage: null,
      resultURL: "",
    };
    ...
    return (
      <ScrollView>
        <View style={styles.container}>
          ...
          <Text style={{ color: "black", textAlign: "center", margin: 20 }}>
            Agrega identificador personal (Cédula de mayor, licencia de
            conducción, etc)
          </Text>
          <TouchableOpacity
            style={[
