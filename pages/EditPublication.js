...
export default class SignUp extends Component {
  ...
  constructor(props) {
    super(props);
    this.state = {
      elementoSeleccionado: "Sandias Grises",
      informacionProducto: ["Sandía Gris", "23", "10", "12/07/2022", "Sandías muy jugosas", "https://pixabay.com/get/g905baba9b9b76350266df398110b6e23a5f5b83291495b169f6ef1bfe1d4a8e86f90c265d334d253b542411276cd208b_1280.jpg"],
      isChecked: false,
      fullName: '',
      email: '',
      password: '',
  ...
  popularInformacionProducto = () => {
    this.setState({elementoSeleccionado:"No seleccionado", informacionProducto:  ["Nombre Del Producto", "0", "0", "Sin Fecha", "Descripción Del Producto", "https://thumbs.dreamstime.com/b/el-logotipo-linear-negro-de-la-c%C3%A1mara-foto-no-le-gusta-ninguna-imagen-disponible-106031126.jpg"]});
  }
